...
func TestNearestDate(t *testing.T) {
	tests := []struct {
		...
		{"25 2 * * *", date(2025, 2, 6, 2, 25), date(2025, 2, 7, 2, 25), ""},
		{"25 2-4 * * *", date(2025, 2, 6, 2, 25), date(2025, 2, 6, 3, 25), ""},
		{"/5 14 6-11 1 *", date(2025, 2, 6, 14, 12), date(2026, 1, 6, 14, 0), ""},
		...
		{"/5 14 * * 1,6", date(2025, 4, 26, 15, 55), date(2025, 4, 28, 14, 0), ""},
	}
